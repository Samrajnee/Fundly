...
const educationArticles = [
  ...
  },
  {
    ...
    category: "BASICS" as const,
    summary:
      "The small cushion in your plan that exists for the unexpected.",
    content:
      "The Buffer is a deliberately small slice of your monthly plan, separate from Savings, Investments, and Goals. Its purpose is different from all three: it's not for a specific target, it's a shock absorber for the small unplanned costs that don't fit any other category, like a slightly higher electricity bill, an unplanned taxi ride, or a gift you didn't budget for. Without a buffer, small surprises would either force you to dip into planned savings or overspend your lifestyle budget for the month. Fundly sizes the buffer based on your living situation and income stability. Someone with irregular income gets a larger buffer than someone on a fixed salary, since irregular income carries more month-to-month uncertainty. If your buffer keeps running out every month, it's usually a sign that some recurring cost is missing from your Recurring Expenses list rather than genuinely being unpredictable.",
    readMinutes: 2,
  },
  {
    ...
    category: "BASICS" as const,
    summary:
      "What counts as an asset, what counts as a liability, and why the number can be negative.",
    content:
      "Net worth is a single number: everything you own of financial value, minus everything you owe. In Fundly, the assets side adds up your investments' current value, your emergency fund balance, and the money saved toward your active goals. The liabilities side adds up the outstanding balance on every debt you've logged: loans, credit cards, EMIs. Net worth is simply assets minus liabilities. It's normal, especially early in your financial life, for this number to be low or even negative. A fresh graduate with an education loan and no investments yet will have negative net worth, and that's not a failure, it's a starting point. What matters more than the number itself is its direction over time, whether it's trending up as you pay down debt and build savings. This is exactly why Fundly lets you save monthly snapshots to track that trend rather than just showing today's figure in isolation.",
    readMinutes: 3,
  },
  {
    ...
    category: "BASICS" as const,
    summary:
      "The four things Fundly checks to calculate your score out of 100.",
    content:
  ...
  },
  {
    ...
    category: "BASICS" as const,
    summary:
      "A safety net for unexpected expenses, so a surprise cost doesn't turn into debt.",
    content:
  ...
  },
  {
    ...
    summary:
      "A Systematic Investment Plan lets you invest a fixed amount regularly instead of all at once.",
    content:
  ...
  },
  {
    ...
    summary:
      "What a credit score measures and why it matters even if you don't have loans yet.",
    content:
  ...
  },
  {
    ...
    summary:
      "Understanding why your whole salary isn't taxed at one flat rate.",
    content:
      "Income tax in a slab system doesn't tax your entire income at one rate - instead, different portions of your income are taxed at increasing rates. For example, if the first ₹3 lakh is tax-free, the next ₹3-6 lakh is taxed at 5%, and so on, then someone earning ₹8 lakh doesn't pay a flat rate on the whole ₹8 lakh - only the portion falling in each bracket is taxed at that bracket's rate. This means moving into a higher slab doesn't reduce your overall take-home as much as people sometimes fear, since only the incremental income is taxed at the higher rate. Exact slabs and rates change with each budget, so it's worth checking current rates when planning your taxes each year.",
    readMinutes: 4,
  },
];
